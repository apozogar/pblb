...
//    String xmlData = cobroService.generarRemesaMensual();
//    if (xmlData == null || xmlData.isEmpty()) {
//      return ResponseEntity.ok(
//          new ApiResponse<>(true, "No se generaron nuevas cuotas para la remesa.", null));
//    }
//    return ResponseEntity.ok(
//        new ApiResponse<>(true, "Remesa XML generada correctamente.", xmlData));
//  }

  @GetMapping(value = "/generar-remesa-excel", produces = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
  public ResponseEntity<InputStreamResource> generarRemesaExcel(
